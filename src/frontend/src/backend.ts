...
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: string, arg1: string, arg2: string): Promise<string> {
    ...
    async getBookingsByMonth(arg0: string): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsByMonth(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
